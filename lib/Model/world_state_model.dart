...
class WorldStateModel {
  ...
  WorldStateModel.fromJson(Map<String, dynamic> json) {
    if (json["updated"] is int) updated = json["updated"];
    if (json["cases"] is int) cases = json["cases"];
    if (json["todayCases"] is int) todayCases = json["todayCases"];
    if (json["deaths"] is int) deaths = json["deaths"];
    if (json["todayDeaths"] is int) todayDeaths = json["todayDeaths"];
    if (json["recovered"] is int) recovered = json["recovered"];
    if (json["todayRecovered"] is int) todayRecovered = json["todayRecovered"];
    if (json["active"] is int) active = json["active"];
    if (json["critical"] is int) critical = json["critical"];
    if (json["casesPerOneMillion"] is int)
      casesPerOneMillion = json["casesPerOneMillion"];
    if (json["deathsPerOneMillion"] is double)
      deathsPerOneMillion = json["deathsPerOneMillion"];
    if (json["tests"] is int) tests = json["tests"];
    if (json["testsPerOneMillion"] is double)
      testsPerOneMillion = json["testsPerOneMillion"];
    if (json["population"] is int) population = json["population"];
